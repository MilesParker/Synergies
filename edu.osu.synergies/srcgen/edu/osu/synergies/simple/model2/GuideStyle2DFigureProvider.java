 ...
 * @generated
 */
public class GuideStyle2DFigureProvider extends DefaultFigureProvider {
	...
	public IFigure getFigure(Object object) {
		...
		color = new Color(Display.getCurrent(), (int) (0.0 * 255),
	...
	public static IFigureProvider getDefault() {
		if (singleton == null) {
			singleton = new GuideStyle2DFigureProvider();
		}
		return singleton;
	}
}
