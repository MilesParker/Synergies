 ...
 * @generated
 */
public class GuideCustomColorProvider implements IColorProvider {
	...
	public GuideCustomColorProvider() {
		...
		colorForInterest.setDataPoint(new UnitIntervalDataPoint() {
			...
			public double getValue(Object object) {
				Guide learner = (Guide) object;
				double interest = learner.getEfficacy();
				if (interest > 1.0) {
					return 1.0;
				}
				return interest;
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new GuideCustomColorProvider();
		}
		return singleton;
	}
}
