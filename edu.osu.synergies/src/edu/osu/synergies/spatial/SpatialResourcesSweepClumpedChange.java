...
public class SpatialResourcesSweepClumpedChange extends SpatialResources {
	public void createViews() {
		...
		try {
			DataOutputView output = new DataOutputView(
					new File(
							"/Users/milesparker/git/Synergies/edu.osu.synergies/output/ResourceEfficacyClumped.txt"));
			addView(output);
		} catch (IOException e) {
