...
public class SocialResources extends Scape {
	...
	public void createScape() {
		...
		guideScape.addInitialRule(new Rule("Initialize State") {
			 ...
			 */
			public void execute(Agent a) {
				((edu.osu.synergies.simple.model2.Guide) a).initializeState();
			}
		});
		...
		guideScape.addInitialRule(new Rule("Initialize ID") {
			 ...
			 */
			public void execute(Agent a) {
				((edu.osu.synergies.simple.model2.Guide) a).initializeID();
			}
		});
		...
		learnerScape.addInitialRule(new Rule("Initialize State") {
			 ...
			 */
			public void execute(Agent a) {
				((edu.osu.synergies.simple.model2.Learner) a).initializeState();
			}
		});
		learnerScape.addRule(new Rule("Guided Growth") {
			 ...
			 */
			public void execute(Agent a) {
				((edu.osu.synergies.simple.model2.Learner) a).guidedGrowth();
			}
		});
		...
		learnerScape.addInitialRule(new Rule("Pick Guide") {
			 ...
			 */
			public void execute(Agent a) {
				((edu.osu.synergies.simple.model2.Learner) a).pickGuide();
			}
		});
		learnerScape.addRule(new Rule("Self Directed Growth") {
			 ...
			 */
			public void execute(Agent a) {
				((edu.osu.synergies.simple.model2.Learner) a)
						.selfDirectedGrowth();
			}
		});
	...
	public void createGraphicViews() {
		...
		}
		{
			...
			guideScape.setRunner(new org.ascape.runtime.NonGraphicRunner());
			Guide guide = new Guide() {
			...
			org.ascape.model.HostCell guideHost = new org.ascape.model.HostCell() {
			...
			guideHost.setOccupant((org.ascape.model.CellOccupant) guide);

			GuideStyle2D guideStyle2D = new GuideStyle2D();
	...
	public static void main(String[] args) {
		(new org.ascape.runtime.swing.SwingRunner()).open(
				"edu.osu.synergies.simple.model2.SocialResources", args);
	}
