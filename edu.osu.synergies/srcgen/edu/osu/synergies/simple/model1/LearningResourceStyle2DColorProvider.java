 ...
 * @generated
 */
public class LearningResourceStyle2DColorProvider implements IColorProvider {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a foreground color for the given Learning Resource.
	 * 
	 * @param object the agent
	 * @return	the foreground color for the element, or <code>null</code> 
	 *   to use the default foreground color
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new LearningResourceStyle2DColorProvider();
		}
		return singleton;
	}
}
