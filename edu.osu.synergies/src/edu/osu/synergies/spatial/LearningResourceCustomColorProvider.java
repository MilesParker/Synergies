 ...
 * @generated
 */
public class LearningResourceCustomColorProvider implements IColorProvider {
	...
	public LearningResourceCustomColorProvider() {
		...
		colorForInterest.setDataPoint(new UnitIntervalDataPoint() {
			...
			public double getValue(Object object) {
				...
				double interest = resource.getEfficacy() * (1.0 / resource.getSpatialResources().getResourceEfficacyMaximum());
				if (interest > 1.0) {
					return 1.0;
				}
				return interest;
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new LearningResourceCustomColorProvider();
		}
		return singleton;
	}
}
