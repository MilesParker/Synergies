 ...
 * @generated
 */
public class LotStyle2DFigureProvider extends DefaultFigureProvider {
	...
	public IFigure getFigure(Object object) {
		...
		if (defaultSpatialResourcesAgentStyle.getSpatialResources()
			...
			color = new Color(Display.getCurrent(), (int) (0.9 * 255),
		...
		if (!defaultSpatialResourcesAgentStyle.getSpatialResources()
			...
			color = new Color(Display.getCurrent(), (int) (0.8 * 255),
	...
	public static IFigureProvider getDefault() {
		if (singleton == null) {
			singleton = new LotStyle2DFigureProvider();
		}
		return singleton;
	}
}
