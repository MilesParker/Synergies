 ...
 * @generated
 */
public class HomeStyle2DColorProvider implements IColorProvider {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a color for Home based on wether we want to fill or not.
	 * 
	...
	public Color getColor(Object object, boolean fill) {
		...
		fillColor = new Color(Display.getCurrent(), (int) (.545 * 255),
				(int) (.54 * 255), (int) (.6 * 255));
		if (fill) {
			return fillColor;
		} else {
			return outlineColor;
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a foreground color for the given Home.
	 * 
	 * @param object the agent
	 * @return	the foreground color for the element, or <code>null</code> 
	 *   to use the default foreground color
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a background color for the given Home.
	 * 
	 * @param object the agent
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new HomeStyle2DColorProvider();
		}
		return singleton;
	}
}
