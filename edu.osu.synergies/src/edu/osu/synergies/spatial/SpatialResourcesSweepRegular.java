...
public class SpatialResourcesSweepRegular extends SpatialResources {
	public void createViews() {
		...
		try {
			DataOutputView output = new DataOutputView(
					new File(
							"/Users/milesparker/git/Synergies/edu.osu.synergies/output/ResourceEfficacyRegular.txt"));
			addView(output);
		} catch (IOException e) {
