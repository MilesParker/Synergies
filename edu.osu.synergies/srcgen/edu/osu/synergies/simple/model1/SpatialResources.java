 ...
 * Model I of the Synergies project demonstration models. The purpose of this model is to explore the interation effects of learners and learning resources across space.
...
How might these basic assumptions effect the distribution of learning interest across a diverse community?

Synergies Project: John Falk, Lynn Direking, Bill Penuel, Miles Parker
Model Development: Miles Parker
...
public class SpatialResources extends Scape
	...
	public void createScape() {
		...
		homeScape.addInitialRule(new Rule("Initialize Location") {
			 ...
			 */
			public void execute(Agent a) {
				((edu.osu.synergies.simple.model1.Home) a).initializeLocation();
			}
		});
		...
		homeScape.addInitialRule(new Rule("Initialize ID") {
			 ...
			 */
			public void execute(Agent a) {
				((edu.osu.synergies.simple.model1.Home) a).initializeID();
			}
		});
	...
	protected void createChartViews() {
		...
		chart.addSeries("Count Learner Not Interested Behavior",
				getInferredChartColor(learner, learnerStyle2DColorProvider));
		...
		chart.addSeries("Count Learner At Home Behavior",
				getInferredChartColor(learner, learnerStyle2DColorProvider));
		...
		lotScape.setRunner(new NonGraphicRunner());
		Lot lot = new Lot() {
			public void requestUpdate() {
			}
			public SpatialResources getSpatialResources() {
		...
		IColorProvider lotStyle2DColorProvider = new LotStyle2DColorProvider();
		addView(chart);
	}
	...
	public static void main(String[] args) {
		(new NonGraphicRunner())
				.openInstance("edu.osu.synergies.simple.model1.SpatialResources");
	}
	...
	public void executeOnMembers() {
		...
		((Lot) district.getPrototypeAgent())
				.startSimulationAgentChild(timeStep);
		...
		((Lot) district.getPrototypeAgent()).calculateTimeStep(timeStep);
