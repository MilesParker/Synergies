 ...
 * @generated
 */
public class ResourceInteractionStyle2DColorProvider implements IColorProvider {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a color for Resource Interaction based on wether we want to fill or not.
	 * 
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a foreground color for the given Resource Interaction.
	 * 
	 * @param object the agent
	 * @return	the foreground color for the element, or <code>null</code> 
	 *   to use the default foreground color
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a background color for the given Resource Interaction.
	 * 
	 * @param object the agent
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new ResourceInteractionStyle2DColorProvider();
		}
		return singleton;
	}
}
