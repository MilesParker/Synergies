 ...
 * @generated
 */
public class GuideStyle2DColorProvider implements IColorProvider {
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a color for Guide based on wether we want to fill or not.
	 * 
	...
	public Color getColor(Object object, boolean fill) {
		...
		Guide actions = (Guide) object;
		Guide defaultSimpleResourcesAgentStyle = actions;
		fillColor = new Color(Display.getCurrent(), (int) (0.0 * 255),
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a foreground color for the given Guide.
	 * 
	 * @param object the agent
	 * @return	the foreground color for the element, or <code>null</code> 
	 *   to use the default foreground color
	...
	/**
	 * <!-- begin-user-doc -->
	 * Provides a background color for the given Guide.
	 * 
	 * @param object the agent
	...
	public static IColorProvider getDefault() {
		if (singleton == null) {
			singleton = new GuideStyle2DColorProvider();
		}
		return singleton;
	}
}
